...
object Config {
  ...
  val projectDir :String = "/C:/Users/admin/Desktop/Esercizi_Big_Data/lab-cse-24-25"
  // The name of the shared bucket on AWS S3 to read datasets
  // val s3sharedbucketName :String = "unibo-bd2425-egallinucci"
  // The name of my bucket name on AWS S3
  //val s3bucketName :String = "unibo-bd2425-abianchi"
